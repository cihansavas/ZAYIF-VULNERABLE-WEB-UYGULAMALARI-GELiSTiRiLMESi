    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">  <h5><a class="label label-success" href="sqli.php">Zaafiyeti Gider</a></h5><br>
          ...
          <code><a href="http://localhost:8080/guvenlik/sql.php?ogrNu=%27or+1%3D1%23&sifre=&BTN=Sorguyu+g%C3%B6nder#&sifre=&BTN=Sorguyu+g%C3%B6nder">http://localhost:8080/guvenlik/sql.php?ogrNu=%27or+1%3D1%23&sifre=&BTN=Sorguyu+g%C3%B6nder#&sifre=&BTN=Sorguyu+g%C3%B6nder</a></code>
          <p>' tan sonra kodun ilk kısmı yazılıp devamına or 1=1 yazdık. 1=1 her zaman true döneceğinden sorgusuz sualsiz bize verileri getirecektir.
          <br>
...
<p>(Örnek Öğrenci Numarası:150202104 Şifre:19951995)</p>
...
$sorgu=mysql_query("Select * from yazlabnotlar where OgrNu='$nu' and ObsSifre='$parola'");
...
{?> <table class="table table-bordered">
<tr><th width="300">Öğrenci Numarası</th><th width="300"> Ad Soyad </th><th> Aldığı Puan</th></tr>
<tr><td><?php echo $dizi['OgrNu']?></td><td> <?php  echo  $dizi['AdSoyad']?> </td><td>  <?php  echo  $dizi['Puan']?></td></tr></table>
	 <?php
}
