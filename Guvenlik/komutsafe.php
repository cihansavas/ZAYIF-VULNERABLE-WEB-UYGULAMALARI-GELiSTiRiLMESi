 ...
 <!-- Modal -->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Komut Enjeksiyonu, Sunucunun işletim sistemini hedef alan bir zaafiyet sömürü yöntemidir.</p>
          <p>Tıpkı diğer zaafiyetlerde olduğu gibi kullanıcıya sunulan input üzerinden alınan verinin filtrelenmeden kullanılmasıyla oluşur.</p>
          <p>Eğer kullanıcının Ip adresini alan ve geriye bilgi döndüren bir uygulamaya sahipseniz. Bunun kontrolünü çok dikkatli yapmalısınız. Sunucuda koşturulan bir shell bizim için çok tehlikeli boyutlara ulaşabilir.</p>
          <p>
          Saldırgan aşağıdaki input a && karakterleriyle araya girip ipconfig yazıp bizim bir çok bilgimize ulaşabilir. Casusun yapabilecekleri sadece işletim sisteminde komut yazma kabiliyetiyle sınırlıdı. Sunucuyu kilitleyebilir, kendisini kullanıcı olarak ekleyebilir ki bu zaafiyetler oldukça büyük ve tehlikeli zaafiyetlerdir.</p>
          <p><code>127.0.0.1 && ipconfig</code> </p><p>Yazarak sizde zaafiyeti test edebilirsiniz.</p>
  ...
  <br><br>
      <div class="col-sm-offset-2 col-sm-10">
        <input type="submit" name="dsa" id="dsa" class="btn btn-default" value="Çalıştır">
      </div>
    </div>
  </form>
    ...
    $sonuc = str_replace( array_keys( $substitutions ), $substitutions, $sonuc );
